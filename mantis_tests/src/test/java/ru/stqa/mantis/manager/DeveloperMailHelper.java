...
import ru.stqa.mantis.manager.developermail.GetIdentifiersResponse;
    ...
    public String receive(DeveloperMailUser user, Duration duration) {
        ...
        while (System.currentTimeMillis() < start + duration.toMillis()) {
            try {
                ...
                GetIdentifiersResponse response1 = new ObjectMapper().readValue(text1, GetIdentifiersResponse.class);
                ...
                if (response1.result().size() > 0) {
                    ...
                    return new String(MimeUtility.decode(new ByteArrayInputStream(response2.result().getBytes()), "quoted-printable").readAllBytes());
                }
